...
public class otherdatebroadcast extends WakefulBroadcastReceiver {
    MediaPlayer mp;
    static Uri alarmUri;
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        Intent in = new Intent(context, otherdatebroadcast.class);
        ...
        md=0;
        mm=0;
        otherdatehelper bh=new otherdatehelper(context) {
        };
        ...
        if(i>0) {
            ...
            ComponentName comp = new ComponentName(context.getPackageName(),
                    otherdateservice.class.getName());
