...
public class allsite {
    myDbHelper myhelper ;
    public allsite ( Context context )
    {
        myhelper = new myDbHelper( context );
    }
    public long insertData ( String name , String cat ,String status)
    {
    ...
    public void getData ()
    {
        ...
        String [] columns = { myDbHelper. UID , myDbHelper. NAME , myDbHelper. CAT, myDbHelper. STATUS};
    ...
    public int updateName ( String oldName , String newName )
    {
        SQLiteDatabase db = myhelper . getWritableDatabase ();
        ContentValues contentValues = new ContentValues ();
        contentValues . put ( myDbHelper. STATUS , newName );
    ...
    {
        private static final String DATABASE_NAME = "alsitebase" ;
        // Database Name
        private static final String TABLE_NAME = "alsitetable" ;
        // Table Name
        ...
        private static final String CREATE_TABLE = "CREATE TABLE " + TABLE_NAME +
                ...
                CAT + " VARCHAR(255) ," +  STATUS + " VARCHAR(255) );" ;
