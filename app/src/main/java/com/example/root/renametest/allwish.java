...
public class allwish {
    myDbHelper myhelper ;
    public allwish ( Context context )
    {
    ...
    {
        private static final String DATABASE_NAME = "alwishbase" ;
        // Database Name
        private static final String TABLE_NAME = "alwishtable" ;
        // Table Name
