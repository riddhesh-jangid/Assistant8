...
public class memo {
    ...
    public long insertData ( String name )
    {
        ...
        contentValues . put (myhoHelper . PAS ,"");
    ...
    public int updatepass ( String oldName , String newName )
    {
        SQLiteDatabase db = myhelper . getWritableDatabase ();
        ContentValues contentValues = new ContentValues ();
        contentValues . put ( myhoHelper . PAS , newName );
        String [] whereArgs = { oldName };
        int count = db . update ( myhoHelper . TABLE_NAME , contentValues , myhoHelper . NAME + " = ?" , whereArgs );
        return count ;
    }
    ...
    {
        private static final String DATABASE_NAME = "memobase" ;
        // Database Name
        ...
        private static final String CREATE_TABLE = "CREATE TABLE " + TABLE_NAME +
                " (" + UID + " INTEGER PRIMARY KEY AUTOINCREMENT, " + NAME + " VARCHAR(255), " + PAS + " VARCHAR(255));";
