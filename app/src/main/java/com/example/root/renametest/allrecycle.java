...
public class allrecycle {
    myDbHelper myhelper ;
    public allrecycle ( Context context )
    {
    ...
    {
        private static final String DATABASE_NAME = "alrecyclebase" ;
        // Database Name
        private static final String TABLE_NAME = "alrecycletable" ;
        // Table Name
