...
public class birthdaystop extends AppCompatActivity {
    Context cc=this;
    birthday bd=new birthday(this);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.birthl);
        birthbroadcast.ringtone.stop();
        LinearLayout lllbbb=(LinearLayout)findViewById(R.id.birthbackid);
        ...
        SimpleAdapter simpleAdapter = new
                SimpleAdapter ( this , al , R . layout . stbirth , from , to );
